...
<div id="mra-body">
  ...
  <div class="ms">
    ...
    ${row('Мін. пауза для реклами (с):', stepper('mra-min-silence', 1.5, 0.1, 30, 0.1), 'БОТ СТАВИТЬ РЕКЛАМУ ЛИШЕ ТАМ, ДЕ Є ПАУЗА ДОВША ЗА N СЕКУНД!\nМісця з коротшою тишею — ПРОПУСКАЮТЬСЯ. Рекомендовано: 1.5-3 сек')}
